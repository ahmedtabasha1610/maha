...
<div class="col-8-lg-8 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        @if (session('error'))
...
@endif
        <h4 class="card-title">{{__('Edit profile information')}}</h4>
         ...
         @endphp
{!! Form::model($userprofile , ['route' => ['profileuser', $userprofile->id], 'method'=>'PATCH','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="form-group">
              ...
              {!! Form::text('phone2', null, array('placeholder' => 'phone2','class' => 'form-control')) !!}
