...
<div class="container">
    <div class="justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($notifiy, ['route' => ['ordernotifiy.update', $notifiy->id], 'method'=>'PATCH']) !!}
                <div class="form-group">
                    <select name="user_id" class="form-control">
                      @foreach($users as $user)
                        <option value="{{$user->id}}"@if($user->id==Auth::user()->id) selected @endif>{{$user->name}}&nbsp;{{$user->lastname}}</option>
                      @endforeach
                    </select>
                </div>
                <div class="form-group">
