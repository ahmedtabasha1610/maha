...
<div class="container">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header">{{__('Create Page')}}
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('content.index') }}">{{__('Back')}}</a>
                </span>
            </div>
            <div class="card-body">
                {!! Form::open(array('route' => 'content.store', 'method'=>'POST','enctype'=>'multipart/form-data')) !!}
                    <div class="form-group">
                        <strong>{{__('Title English')}}:</strong>
                        {!! Form::text('title', null, array('placeholder' => __('Title'),'class' => 'form-control')) !!}
                    </div>

                      <div class="form-group">
                        <strong>{{__('Title Arabic')}}:</strong>
                        {!! Form::text('titlear', null, array('placeholder' => __('Title'),'class' => 'form-control')) !!}
                    </div>
                    ...
                    <div class="form-group">
                        <strong>{{__('Description')}}:</strong>
                        {!! Form::textarea('bodyar', null, array('placeholder' => __('description'),'class' => 'form-control tinymce-editor','cols'=>'40','rows'=>'5')) !!}
                    </div>
                    <div class="form-group">
